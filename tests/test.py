...
def alu_test(f):
    ...
    for fn in (0,1):
        for a in (0,1,-1,0xAAAAAAAA,0x55555555):
            for b in (0,1,-1,0xAAAAAAAA,0x55555555):
                y,z,v,n = arith_result(fn,a,b)
                alu_test_cycle(f,fn,a,b,y,z,v,n)

    # test cmp
    alu_test_cycle(f,0b00001,0x00000005,0xDEADBEEF,xxx) # z=0, v=0, n=0
    alu_test_cycle(f,0b00001,0x12345678,0x12345678,xxx) # z=1, v=0, n=0
    alu_test_cycle(f,0b00001,0x80000000,0x00000001,xxx) # z=0, v=1, n=0
    alu_test_cycle(f,0b00001,0xDEADBEEF,0x00000005,xxx) # z=0, v=0, n=1
    alu_test_cycle(f,0b00001,0x7FFFFFFF,0xFFFFFFFF,xxx) # z=0, v=1, n=1
